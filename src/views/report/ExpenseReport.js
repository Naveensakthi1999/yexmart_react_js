...
import { expenseReportTableData, expenseReportFilterData } from '../../components/form-field';
...
const ExpenseReport = () => {
    ...
    const [tableData, setTableData] = useState(expenseReportTableData);
    ...
    const columns = useMemo(() => [
        ...
        columnHelper.accessor('expense_code', {
            header: () => 'Expense Code',
        ...
        columnHelper.accessor('expense_for', {
            header: () => 'Expense for',
            cell: info => <Typography>{info.getValue()}</Typography>,
        }),
    ...
    return (
        <PageContainer title="Expense Report" description="this is Expense Report">
            <Breadcrumb title="Expense Report Information" items={BCrumb} />
