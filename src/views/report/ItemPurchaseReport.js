...
const ItemPurchaseReport = () => {
    ...
    return (
        <PageContainer title="Item Purchase Report" description="this is Item Purchase Report">
            <Breadcrumb title="Item Purchase Report Information" items={BCrumb} />
...
export default React.memo(ItemPurchaseReport);
