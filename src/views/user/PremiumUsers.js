...
const PremiumUsers = () => {
  ...
  const BCrumb = useMemo(() => [{ to: '/', title: 'Home' }, { title: 'Block User List' }], []);
  ...
  const handleSubmit = async (e) => {
    ...
    try {
      ...
      (formData.ispremium = formData.ispremium === true ? 'active' : 'inactive'),
  ...
  return (
    <>
      <PageContainer title="Premium Users Details" description="this is User Form page">
        <Breadcrumb title="Premium Users Information" items={BCrumb} />
...
export default React.memo(PremiumUsers);
